...
flowchart TB
    ...
    DB[("SQLite WAL · 50 tables<br/>pipeline_events · certifications · audit trail")]:::sink
...
```bash
make test       # full suite — 5,404 backend (223 files) + 917 frontend (82 files) + 38 Playwright e2e (8 specs)
