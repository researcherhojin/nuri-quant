...
accounts:
  ...
  kakaopay:
    ...
    broker: "카카오페이증권"
    currency: USD
    total_invested: 48323344  # KRW
    holdings:
      - { ticker: TSLA,     qty: 33.0016, avg: 343.39, sector: EV/AI }
      - { ticker: BULL,     qty: 100,     avg: 47.00,  sector: ETF }
      - { ticker: NVDA,     qty: 20.001,  avg: 132.14, sector: Semiconductor }
      - { ticker: NBIS,     qty: 17,      avg: 109.20, sector: AI/Cloud }
      - { ticker: GOOGL,    qty: 5,       avg: 269.91, sector: BigTech }
      - { ticker: TSLL,     qty: 96,      avg: 16.93,  sector: Leveraged_ETF, flag: SELL }
      - { ticker: OKLO,     qty: 20,      avg: 125.99, sector: Nuclear }
      ...
      - { ticker: "005930.KS", qty: 1,    avg: 59700,  sector: Semiconductor }
  ...
  mirae:
    ...
    cash_usd: 8500
    holdings:
      - { ticker: TSLA,     qty: 11,  avg: 350.00, sector: EV/AI }
