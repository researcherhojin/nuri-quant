...
export const mockPortfolio = {
  holdings: [
    { ticker: "AAPL", account: "kakaopay", quantity: 10, avg_price: 180, currency: "USD", sector: "Tech", latest_price: 195, price_date: "2026-03-31" },
    { ticker: "TSLA", account: "kakaopay", quantity: 5, avg_price: 250, currency: "USD", sector: "EV/AI", latest_price: 280, price_date: "2026-03-31" },
  ],
  count: 2,
};
