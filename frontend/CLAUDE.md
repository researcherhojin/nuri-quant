...
npm run test           # vitest run (1722 tests, 143 files)
...
should be **253**. (이 숫자는 어떤 게이트도 검사하지 않아 조용히 낡는다 — #1431 시점에 적혀
있던 249 는 실측 250 이었고, 그 PR 이 1 파일, #1429 가 2 파일을 더해 253 이 됐다.)
