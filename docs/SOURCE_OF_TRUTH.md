...
| 7 Harness Principles (§5.8) | `docs/STRATEGY.md §5.8` | `CLAUDE.md` Always-on (verbatim — intentional duplication for context-stability per 2026-04-29 user directive) | scoped CLAUDE.md, `AGENTS.md` (link only) |
...
| 2-machine deploy (MBP dev ↔ Mac mini receiver) | `docs/ARCHITECTURE.md` (operational detail) — to be split into `docs/OPERATIONS.md` in PR 5 of refactor | `CLAUDE.md` Commands section (`make deploy-mini` 1-line); `README.md` (high-level pointer until OPERATIONS.md split) | scoped CLAUDE.md |
