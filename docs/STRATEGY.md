...
### 4.1 테스트
| 항목 | 기준 | 현재 |
| Backend tests | Codecov 1% relative regression (목표 ≥ 95%) | 8,089 tests, 375 files (statement coverage **99%** — 17/23,311 미커버 9개 파일, partial branch 81, `make ci-cov` 2026-08-14) |
| Frontend tests | 목표 ≥ 90% | 1,722 tests, 145 files |
