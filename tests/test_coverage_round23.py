...
class TestPriceTargets:
    ...
    def test_classify_stock_type_sector_growth(self, db_path):
        ...
        _seed_portfolio(db_path, [("test", "SEMCO", 10, 100.0, "USD", "Semiconductor")])
    ...
    def test_check_take_profit_target2(self, db_path):
        ...
        _seed_portfolio(db_path, [("test", "AAPL", 10, 100.0, "USD", "Technology")])
    ...
    def test_check_take_profit_no_entry(self, db_path):
        ...
        _seed_portfolio(db_path, [("test", "AAPL", 10, 0, "USD", "Technology")])
    ...
    def test_check_portfolio_mdd_no_violation(self, db_path):
        ...
        _seed_portfolio(db_path, [("test", "AAPL", 10, 150.0, "USD", "Technology")])
    ...
    def test_check_portfolio_mdd_violation(self, db_path):
        ...
        _seed_portfolio(db_path, [("test", "AAPL", 100, 200.0, "USD", "Technology")])
    ...
    def test_check_portfolio_mdd_with_krw(self, db_path):
        ...
        _seed_portfolio(db_path, [("test", "005930.KS", 10, 70000.0, "KRW", "Semiconductor")])
