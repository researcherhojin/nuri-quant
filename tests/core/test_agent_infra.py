...
class TestSchemaMigrations:
    ...
    def test_schema_version_at_42(self, db_path):
        """Phase 1+2 + discord_outbox + agent_control/agent_dev_log channel CHECK 확장 (#582) → 42."""
        assert get_schema_version(db_path) == 42
