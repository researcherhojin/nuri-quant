...
class TestSchemaMigrations:
    """15 신규 migration (#25 audit / #26 flags / #27 runs / #28 messages / #29 walkforward_runs / #30 regime_posteriors / #31 hypotheses / #32 causal_audits / #33 agent_decisions / #34 decision_outcomes / #35 execution_blocks / #36 incidents / #37 dr_replicas / #38 collector_runs / #39 drift_alerts) 적용 확인."""

    def test_schema_version_at_39(self, db_path):
        """Phase 1+2 migrations 모두 적용 → schema version 39 (#38 collector_runs + #39 drift_alerts 포함)."""
        assert get_schema_version(db_path) == 39
